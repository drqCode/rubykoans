...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # += is a shorthand for a = a+b which create a new object after concatenation, << is a alias for x.concat(<string>)
    # which modifies the object value. Modifying an object is faster than creating a new one.
  end
