...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer first solution, because it is more intuitive for new Ruby developers :)
  # Second option can become more cleanly if it used in classes that declares both types of method
  # and more than 1 class method
